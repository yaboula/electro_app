...
import { Gamepad2, Truck, ShieldCheck, Headset, ArrowRight, Zap } from "lucide-react";
...
const categories = [
  { name: "PlayStation", emoji: "🎮", color: "from-blue-600/20 to-blue-800/20" },
  { name: "Xbox", emoji: "🟢", color: "from-green-600/20 to-green-800/20" },
  { name: "Nintendo", emoji: "🔴", color: "from-red-600/20 to-red-800/20" },
  { name: "PC Gaming", emoji: "🖥️", color: "from-purple-600/20 to-purple-800/20" },
  { name: "Accessoires", emoji: "🎧", color: "from-orange-600/20 to-orange-800/20" },
  { name: "Occasions", emoji: "♻️", color: "from-teal-600/20 to-teal-800/20" },
];
